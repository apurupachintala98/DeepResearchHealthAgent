...
type HealthAnalyticsDashboardProps = {
...
export const HealthAnalyticsDashboard: React.FC<HealthAnalyticsDashboardProps> = ({ result }) => {

  // Extract entity values from result.entities
